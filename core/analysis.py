...
STOPWORDS = {
    'uk': {'та', 'і', 'у', 'на', 'з', 'до', 'не', 'що', 'як', 'але', 'це', 'за', 'для', 'в', 'а', 'від', 'про'},
...
def analyze_diary():
    """Main analysis function returning paths to results"""
    analysis_date = datetime.now().strftime("%Y-%m-%d")
    output_dir = Path.home() / "diary_analysis" / analysis_date
    ...
    return {
        'wordcloud': str(output_dir / "wordcloud.png"),
        'frequency_chart': str(output_dir / "frequency_chart.png"),
        'frequencies_file': str(output_dir / "word_frequencies.txt")
    }
